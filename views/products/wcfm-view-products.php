					...
					<thead>
						<tr>
						  <th>
							...
							<th class='hidey'><?php _e( 'SKU', 'wc-frontend-manager' ); ?></th>
							<th><?php _e( 'Status', 'wc-frontend-manager' ); ?></th>
							<th class='hidey'><?php _e( 'Stock', 'wc-frontend-manager' ); ?></th>
							<th class='hidey'><?php _e( 'Price', 'wc-frontend-manager' ); ?></th>
							<th><?php _e( 'Categories', 'wc-frontend-manager' ); ?></th>
							<th class='hidey'><span class="wcfmfa fa-cubes text_tip" data-tip="<?php _e( 'Type', 'wc-frontend-manager' ); ?>"></span></th>
							...
							<th class='hidey'><?php _e( 'Store', 'wc-frontend-manager' ); ?></th>
							<th class='hidey'><?php _e( apply_filters( 'wcfm_products_additional_info_column_label', __( 'Additional Info', 'wc-frontend-manager' ) ) ); ?></th>
							<th class='hidey'><?php _e( 'Actions', 'wc-frontend-manager' ); ?></th>
						</tr>
					</thead>
					<tfoot>
						<tr>
...
tr.odd td:nth-child(12){
	display: none !important;
}

tr.odd td:nth-child(13){
	display: none !important;
}

tr.odd td:nth-child(14){
	display: none !important;
}
</style>
