...
class WCFM_WCBookings {
  ...
  function wcb_product_manage_general( $product_id, $product_type ) {
	  ...
	  <div class="page_collapsible products_manage_downloadable booking" id="wcfm_products_manage_form_booking_options_head"><label class="wcfmfa fa-calendar"></label><?php _e('Booking Options', 'wc-frontend-manager'); ?><span></span></div>
