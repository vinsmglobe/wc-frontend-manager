        ...
        $vendor_role->add_cap( 'read_private_shop_orders' );
				...
				if( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
					if( WCFMu_Dependencies::wcfm_wc_fooevents() ) {
						$vendor_role->remove_cap( 'publish_event_magic_tickets' );
						$vendor_role->remove_cap( 'edit_event_magic_tickets' );
						$vendor_role->remove_cap( 'edit_published_event_magic_tickets' );
						$vendor_role->remove_cap( 'edit_others_event_magic_tickets' );
						$vendor_role->remove_cap( 'delete_event_magic_tickets' );
						$vendor_role->remove_cap( 'delete_others_event_magic_tickets' );
						$vendor_role->remove_cap( 'read_private_event_magic_tickets' );
						$vendor_role->remove_cap( 'edit_event_magic_ticket' );
						$vendor_role->remove_cap( 'delete_event_magic_ticket' );
						$vendor_role->remove_cap( 'read_event_magic_ticket' );
						$vendor_role->remove_cap( 'edit_published_event_magic_ticket' );
						$vendor_role->remove_cap( 'publish_event_magic_ticket' );
						$vendor_role->remove_cap( 'delete_others_event_magic_ticket' );
						$vendor_role->remove_cap( 'delete_published_event_magic_ticket' );
						$vendor_role->remove_cap( 'delete_published_event_magic_tickets' );
					}
				}
